...
export class LabelCategory1621479880832 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "label_category" ("_id" SERIAL NOT NULL, "_name" character varying(500) NOT NULL, "_serviceId" integer NOT NULL, CONSTRAINT "PK_5c2230a7d066952eac6772635cf" PRIMARY KEY ("_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "label" ADD CONSTRAINT "FK_951fda8ace32a9a31ceae08c668" FOREIGN KEY ("_categoryId") REFERENCES "label_category"("_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "label_category" ADD CONSTRAINT "FK_e1e0491373e3920fb887d5d061e" FOREIGN KEY ("_serviceId") REFERENCES "service"("_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
