...
export class Label1617033565406 implements MigrationInterface {
	public name = 'Label1617033565406';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "label" ("_id" SERIAL NOT NULL, "_labelText" character varying(500) NOT NULL, "_serviceId" integer, CONSTRAINT "PK_074a1fd1507efd236f0c1995f62" PRIMARY KEY ("_id"))`,
		);
		await queryRunner.query(
