...
export class ServiceSettingsBookingLimitation1637888023055 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "service_setting" ("_id" SERIAL NOT NULL, "_bookingLimitation" character varying NOT NULL DEFAULT 'NoLimitations', "_limitationNumber" integer, CONSTRAINT "PK_216bb4361584336831d9be23de8" PRIMARY KEY ("_id"))`);
