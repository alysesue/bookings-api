...
describe('Bookings functional tests', () => {
	...
	let serviceProviderId2: string;

	const SERVICE_PROVIDER_NAME_3 = 'SP3';
	let serviceProviderId3: string;
	...
	it('should get booking by booking id', async () => {
		...
		const response = await OrganisationAdminRequestEndpointSG.create({}).get(`/bookings/${resId}`, {}, 'V2');
